...
# -*- coding: utf-8 -*-
#
# token-utils documentation build configuration file, created by
...
htmlhelp_basename = "token-utils-doc"
...
man_pages = [(master_doc, "token-utils", "token-utils Documentation", [author], 1)]
